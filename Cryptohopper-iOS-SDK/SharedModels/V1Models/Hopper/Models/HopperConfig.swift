...
public class HopperConfig : Codable {
    ...
    public var dca_mode : String?
    public var auto_dca_time : String?
    public var auto_dca_max : String?
    public var auto_dca_percentage : String?
    public var auto_dca_percentage_2 : String?
    public var auto_dca_percentage_3 : String?
    public var auto_dca_percentage_4 : String?
    public var auto_dca_percentage_5 : String?
    public var auto_dca_percentage_6 : String?
    ...
    //Portfolio Bot Configs
    public var rebalance_time_type : String?
    public var rebalance_time_count : String?     // Changed from Int to String
    public var rebalance_on_percentage : String?  // Changed from Int to String
    public var rebalance_percentage : String?     // Changed from Float to String
    public var portfolio : [String:String]?
    public var rebuy_positions : String?
    public var send_portfolio_summary_email : String?
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case dca_mode = "dca_mode"
        case auto_dca_time = "auto_dca_time"
        case auto_dca_max = "auto_dca_max"
        case auto_dca_percentage = "auto_dca_percentage"
        case auto_dca_percentage_2 = "auto_dca_percentage_2"
        case auto_dca_percentage_3 = "auto_dca_percentage_3"
        case auto_dca_percentage_4 = "auto_dca_percentage_4"
        case auto_dca_percentage_5 = "auto_dca_percentage_5"
        case auto_dca_percentage_6 = "auto_dca_percentage_6"
        ...
        case rebalance_time_type = "rebalance_time_type"
        case rebalance_time_count = "rebalance_time_count"
        case rebalance_on_percentage = "rebalance_on_percentage"
        case rebalance_percentage = "rebalance_percentage"
        case portfolio = "portfolio"
        case rebuy_positions = "rebuy_positions"
        case send_portfolio_summary_email = "send_portfolio_summary_email"
    }
